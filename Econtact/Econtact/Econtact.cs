...
namespace Econtact
{
    public partial class Econtact : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            c.Name = txtboxFirstName.Text;
            c.Number = txtboxLastName.Text;
            c.Date = txtBoxContactNumber.Text;
            c.Computer = txtBoxAddress.Text;
        ...
        private void txtboxSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM tbl_contact WHERE Name LIKE '%"+keyword+"%' OR Number LIKE '%"+keyword+"%' OR Computer LIKE '%"+keyword+"%'",conn);
